...
test.describe("Checkout", () => {
  ...
  test.describe("Pagamento e Confirmação", () => {
    ...
    test("deve criar um pedido com sucesso para pagamento à vista", async ({
      app,
    }) => {
      const customer = {
        name: "Fernando",
    ...
    test("deve encaminhar para análise de crédito quando o score do CPF for entre 501 e 700 no financiamento", async ({
      app,
    }) => {
      const customer = {
        name: "Tony",
    ...
    test("deve reprovar o crédito quando o score do CPF for menor ou igual a 500 no financiamento com entrada menor que 50%", async ({
      app,
    }) => {
      const customer = {
        name: "Diana",
    ...
    test("deve reprovar o crédito quando o score do CPF for menor ou igual a 500 no financiamento com entrada igual a 50%", async ({
      app,
    }) => {
      const customer = {
        name: "Richard",
    ...
    test("deve aprovar o crédito quando o score do CPF for menor ou igual a 500 no financiamento com entrada mair que 50%", async ({
      app,
    }) => {
      const customer = {
        name: "Axl",
